      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;">
        ...
        <tr>
          <td style="padding:32px;">
            ...
            <p style="font-size:14px;line-height:1.5;margin:0 0 16px;background:#f4f6f8;border:1px solid #E0E0E0;border-radius:6px;padding:12px 16px;">
              <strong>Your username:</strong> ${champion.username || 'See your administrator'}
            </p>
