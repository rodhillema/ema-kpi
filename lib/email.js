      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:10px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
        ...
        <tr>
          <td style="background:#ec482f;padding:22px 32px;">
            <table cellpadding="0" cellspacing="0" style="width:100%;">
              <tr>
                <td width="48" style="width:48px;vertical-align:middle;padding-right:14px;">
                  <img src="${appUrl}/email-logo.png" alt="\u0112MA" width="40" height="40" style="display:block;border:0;outline:none;width:40px;height:40px;">
                </td>
                <td style="vertical-align:middle;text-align:right;">
                  <div style="font-family:'Oswald',Helvetica,Arial,sans-serif;font-size:13px;font-weight:400;letter-spacing:1.5px;text-transform:uppercase;color:rgba(255,255,255,0.95);white-space:nowrap;">
                    Impact Hub
                  </div>
                </td>
              </tr>
        ...
        <tr>
          <td style="padding:32px;">
            ...
            <p style="font-size:13px;line-height:1.55;color:#5A5A5A;margin:0 0 8px;">
              Questions? Email us at <a href="mailto:trellissupport@ema.org" style="color:#ec482f;text-decoration:none;">trellissupport@ema.org</a>.
            </p>
      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:10px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.06);">
        ...
        <tr>
          <td style="padding:32px;">
            ...
            <p style="font-size:13px;line-height:1.55;color:#5A5A5A;margin:0 0 8px;">
              This link expires in <strong>48 hours</strong>. If it has expired, contact your administrator to request a new one.
            </p>
            <p style="font-size:13px;line-height:1.55;color:#5A5A5A;margin:0 0 8px;">
              Questions? Email us at <a href="mailto:trellissupport@ema.org" style="color:#ec482f;text-decoration:none;">trellissupport@ema.org</a>.
            </p>
