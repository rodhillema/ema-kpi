...
(function() {
  ...
  var NAV_ITEMS = [
    ...
    { group: "How We're Doing", items: [
      ...
      { href: '/#hq-resources', label: 'HQ Resources', match: ['/report/flagged-needs', '/report/kpi1-preservation-breakdown', '/report/ep-rr-diagnostic', '/report/kpi2-diagnostic'], adminOnly: true,
    ...
    { group: 'Trellis Live', items: [
      { href: '/#moms', label: 'Our Moms', match: ['/report/mom-status', '/track-journey', '/court-summary'],
      ...
      { href: '/#action-reports', label: 'Action Items', match: ['/report/child-welfare-status'], adminOnly: true,
        icon: '<svg viewBox="0 0 16 16"><rect x="2" y="2" width="12" height="12" rx="1.5"/><polyline points="5,8 7,10 11,6"/></svg>' },
    ]},
